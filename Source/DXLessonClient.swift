...
public final class DXLessonClient: DXHTTPClient {
...
//    }
        ...
        -> Void
    {
        ...
        let handleSuccess: HandleSuccess<[DXLesson]> = { response, data in
            guard let json = try JSONSerialization.jsonObject(with: data, options: []) as? [String: Any],
                let docs = json["docs"] else {
                    throw DXError.API.unableToDeserializeResult(message: "Unable to deserialize DXLesson array.")
            }
