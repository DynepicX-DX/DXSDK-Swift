//
//  PlayPortalAssessmentClient.swift
//  Pods
//
...
public final class PlayPortalAssessmentClient: PlayPortalHTTPClient {
  
  public static let shared = PlayPortalAssessmentClient()
  ...
  /**
   ...
   - Parameter assessmentId: The ID of the requested assessment. This can be found when reading an
      assessment lesson. Corresponds to the `media` property of a `PlayPortalLesson`.
  ...
  public func getAssessment(
    assessmentId: String,
    _ completion: @escaping (_ error: Error?, _ assessment: [PlayPortalAssessmentQuestion]?) -> Void)
    -> Void
  {
