...
public final class PlayPortalStudentClient: PlayPortalHTTPClient {
  
  public static let shared = PlayPortalStudentClient()
  ...
  public func getStudents(
    ...
    limit: Int? = nil,
    page: Int? = nil,
    _ completion: @escaping (_ error: Error?, _ students: [PlayPortalProfile]?) -> Void)
    -> Void
  {
  ...
  public func addComment(
    ...
    text: String,
    lessonId: String? = nil,
    _ completion: @escaping (_ error: Error?, _ comment: PlayPortalStudentComment?) -> Void)
    -> Void
  {
    let body: [String: Any] = [
      "studentId": studentId,
  ...
  public func getComments(
    ...
    courseId: String?,
    lessonId: String?,
    _ completion: @escaping (_ error: Error?, _ comments: [PlayPortalStudentComment]?) -> Void)
    -> Void
  {
    let params: [String: Any] = [
