...
public final class PlayPortalLeaderboard {
    ...
    */
    public func getLeaderboard(
        ...
        -> Void
    {
        RequestManager.shared.request(LeaderBoardRouter.get(categories: categories, page: page, limit: limit), at: "docs", completion)
    }
    ...
    */
    public func updateLeaderboard(
        ...
        -> Void
    {
        RequestManager.shared.request(LeaderBoardRouter.update(score: score, categories: categories), completion)
    }
}
