...
public final class PlayPortalUser: PlayPortalClient {
    ...
    public func getProfile(
        ...
        -> Void
    {
        request(url: UserEndpoints.userProfile, method: .get, completion)
    }
    ...
    */
    public func getFriendProfiles(
        ...
        -> Void
    {
        request(url: UserEndpoints.friendProfiles, method: .get, completion)
    }
    ...
    */
        ...
        -> Void
    {
        ...
        request(url: UserEndpoints.randomSearch, method: .get, queryParameters: queryParameters, completion)
    }
